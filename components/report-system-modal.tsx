...
interface ReportSystemModalProps {
	onClose: () => void;
	onSuccess?: () => void;
}

export function ReportSystemModal({ onClose, onSuccess }: ReportSystemModalProps) {
			...
			{success ? (
				...
				<div className="p-6">
					<div className="flex items-center gap-3 mb-6">
						...
						<div>
							<h2 className="text-2xl font-bold">รายงานระบบ</h2>
							<p className="text-sm text-muted-foreground">แจ้งบัคหรือให้ feedback</p>
						</div>
					</div>
					...
					<form onSubmit={handleSubmit} className="space-y-4">
						<div>
							...
							<input
								...
								placeholder="เช่น: พบบัค, ข้อเสนอแนะ, ฯลฯ"
								className={cn(
						...
						<div>
							...
							<textarea
								...
								placeholder="อธิบายรายละเอียดบัคหรือข้อเสนอแนะ..."
								rows={6}
								className={cn(
									"w-full px-4 py-3 rounded-xl border border-border",
									"bg-background focus:outline-none focus:ring-2 focus:ring-primary",
